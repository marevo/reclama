                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <form action="../App/controllers/controllerOneSupplier.php" method="post">
                        <table>
                            ...
                            <tr><td>email</td><td><a target="_blank" title="написать письмо поставщику" href="mailto:<?php echo $supp->email0 ; ?>" ><?php echo $supp->email0  ?></a></td><td class="tdDisplayNone"><input name="email0" maxlength="50" size="50" type="text" value="<?php echo $supp->email0 ?>"/></td></tr>
