                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <form action="../App/controllers/controllerOneClient.php" method="post">
                            <table>
                                ...
                                <tr><td>телефон 1</td><td><?php echo $client->phone0 ; ?></td><td class="tdDisplayNone"><input maxlength="20" size="20" name="phone0" title="<?php echo $client->phone0 ?>" type="text" pattern="(\d{5,13})?" value="<?php echo $client->phone0 ?>"/></td></tr>
                                <tr><td>телефон 2</td><td><?php echo $client->phone1 ; ?></td><td class="tdDisplayNone"><input maxlength="20" size="20" name="phone1" title="<?php echo $client->phone1 ?>" type="text" pattern="(\d{5,13})?" value="<?php echo viewNull( $client->phone1); ?>"/></td></tr>
